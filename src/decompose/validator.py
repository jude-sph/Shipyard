...
def run_semantic_judge(tree: RequirementTree, cost_tracker: CostTracker, model: str | None = None) -> SemanticReview:
    ...
    try:
        result = call_llm(prompt, cost_tracker, "judge", 0, model=model)
